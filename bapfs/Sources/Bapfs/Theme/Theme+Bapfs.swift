                ...
                .wrapper(
                    .section(.id("home_hero"),
                             .article(
                                 ...
                                 .a(.class("base_button"),
                                    .href("/games/"),
                                    .text("Find a Game")) // a.base_button
                             )), // section#home_hero
                    .section(.class("section_wrapper"),
                             .article(.class("span12 post"),
                                      .contentBody(index.body)) // article
            ...
            return HTML(
                ...
                .body(
                    ...
                    .wrapper(
                        ...
                        .section(.class("section_wrapper"),
                                 .article(.class("span12 post"),
                                          .contentBody(section.body)) // article.span12 post
                        ),
                ...
                .wrapper(
                    .section(.class("section_wrapper"),
                             .article(.class("span12 post"),
                                      ...
                                      .hr(),
                                      .p("Tagged with: "),
                                      .tagList(for: item, on: context.site)) // article .span12 post
...
static func header<T: Website>(for context: PublishingContext<T>, selectedSection: T.SectionID?) -> Node {
    ...
    return .header(
        .div(.class("menu_toggler"),
             .span(.class("open_close"))), // .menu_toggler
        .nav(.id("fixed_nav"),
...
static func contactForm<T: Website>(for _: T) -> Node {
